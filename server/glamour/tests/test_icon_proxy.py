...
from routes.api import ICON_BASE_URL
...
def test_hd_icon_is_fetched_and_cached():
    ...
    expected_url = f"{ICON_BASE_URL}/041000/041261_hd.png"
...
def test_hd_failure_falls_back_to_hr1():
    ...
    assert requested_urls == [
        f"{ICON_BASE_URL}/041000/041262_hd.png",
        f"{ICON_BASE_URL}/041000/041262_hr1.png",
    ]
...
def test_non_hd_segment_only_fetches_hr1():
    ...
    assert response.status_code == 200
    assert response.data == icon_data
    assert requested_urls == [f"{ICON_BASE_URL}/065000/065025_hr1.png"]
...
def test_existing_hr1_cache_does_not_block_hd_upgrade():
    ...
    assert requested_urls == [f"{ICON_BASE_URL}/041000/041263_hd.png"]
